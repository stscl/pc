...
RcppFNN <- function(target, rt, eps, lib, pred, E, tau = 1L, style = 0L, dist_metric = "euclidean", threads = 1L, parallel_level = 0L, nb = NULL, nrows = NULL) {
    .Call(`_pc_RcppFNN`, target, rt, eps, lib, pred, E, tau, style, dist_metric, threads, parallel_level, nb, nrows)
}
